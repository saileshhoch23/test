import { Layout,  DatePicker, Space, Input, Spin, Modal  } from "antd";
        ...
        {orderDetils?.orderId ? (
          <div className="col-lg-8">
            <div className="order-details-box">
              ...
              <button className=" btn btn-dark me-sm-4 me-2"  type="button" onClick={() => reorderItem(orderDetils)}>
                Reorder
                </button>
                {orderDetils?.returned == false &&<button className="btn btn-outline-secondary"  type="button"  onClick={() => returnModel(orderDetils, true)}>
                Return
                </button>}
              </div>
            </div>

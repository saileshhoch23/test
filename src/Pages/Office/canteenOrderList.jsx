      ...
      <div className="row">
        ...
        {orderDetils?.orderId ? (
          <div className="col-lg-8">
                  ...
                  <div className="d-flex align-items-center justify-content-between border-bottom flex-wrap">
                    ...
                    <div className="position-relative">
                      <img
                        ...
                        alt="img-canteen"
                      />
                        <button className="btn office-edit-btn" type="button" onClick={()=>cancelOrder(orderDetils)}><RiDeleteBin6Line /></button>
                      </div>
                      <div>
            ...
            {  orderDetils.canceled == true ?   <button className=" btn btn btn-outline-danger  me-sm-4 me-2"  type="button" disabled={true}>
              Rejected Order 
                </button>:
...
export default CanteenOrderList;
